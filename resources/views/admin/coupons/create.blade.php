...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-0 fw-bold">Create Coupon Discount</h4>
            <small class="text-muted">Fill out promo terms, validations, B2B restrictions and auto apply attributes.</small>
        </div>
            ...
            <form action="{{ route('admin.coupons.store') }}" method="POST">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select border-start-0 ps-0 bg-light-focus" id="type" name="type" required onchange="updateValueLabels()">
                                ...
                                <option value="fixed" {{ old('type') === 'fixed' ? 'selected' : '' }}>Fixed Amount Discount (Rs.)</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch p-3 border rounded-3 bg-light-subtle shadow-sm">
                                    <input class="form-check-input ms-0 me-2" type="checkbox" role="switch" id="for_dealers_only" name="for_dealers_only" {{ old('for_dealers_only') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch p-3 border rounded-3 bg-light-subtle shadow-sm">
                                    <input class="form-check-input ms-0 me-2" type="checkbox" role="switch" id="auto_apply" name="auto_apply" {{ old('auto_apply') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch p-3 border rounded-3 bg-light-subtle shadow-sm">
                                    <input class="form-check-input ms-0 me-2" type="checkbox" role="switch" id="is_active" name="is_active" checked {{ old('is_active', '1') === '0' ? '' : 'checked' }}>
                ...
                <div class="mt-5 border-t pt-4">
                    <button type="submit" class="btn btn-primary fw-bold px-4 py-2.5 rounded-3 shadow-sm hover-up">
                        <i class="bi bi-check-circle me-1"></i> Save Coupon Code
                    </button>
