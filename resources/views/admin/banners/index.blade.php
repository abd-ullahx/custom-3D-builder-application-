...
@section('header', 'Banners Management')
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                ...
                <div class="d-flex flex-column flex-md-row gap-2">
                    ...
                    <a href="{{ route('admin.banners.create') }}" class="btn btn-primary text-nowrap">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @forelse($banners as $banner)
                            <tr>
                                <td class="ps-4 fw-medium">#{{ $banner->id }}</td>
                                <td>
                                    <img src="{{ asset('images/' . $banner->image) }}" alt="Banner" style="max-width: 100px; max-height: 60px;">
                                </td>
                                <td>{{ $banner->order }}</td>
                                <td>
                                    @if ($banner->status == 1)
                                ...
                                <td class="small">
                                    {{ Carbon::parse($banner->created_at)->isoFormat('LLL') }}
                                </td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-4 text-muted">No banner found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
